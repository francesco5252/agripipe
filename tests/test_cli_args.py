...
def test_cli_run_fuzzy_flag(mock_save, mock_load, mock_cleaner, runner, tmp_path):
    ...
    result = runner.invoke(app, ["run", "--input", str(input_file), "--output", str(output_file), "--preset", "ulivo_ligure", "--fuzzy"])
...
def test_cli_run_input_dir(mock_save, mock_batch_load, mock_cleaner, runner, tmp_path):
    ...
    result = runner.invoke(app, ["run", "--input-dir", str(input_dir), "--output", str(output_file), "--preset", "ulivo_ligure"])
...
def test_cli_run_auto_units(mock_save, mock_load, mock_cleaner, runner, tmp_path):
    ...
    result = runner.invoke(app, ["run", "--input", str(input_file), "--output", str(output_file), "--preset", "ulivo_ligure", "--auto-units"])
